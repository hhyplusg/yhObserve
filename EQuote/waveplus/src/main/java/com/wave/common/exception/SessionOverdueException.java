...
public class SessionOverdueException extends BaseException{  
	...
	public SessionOverdueException(String message,Exception e) {
	...
	public SessionOverdueException(String message, int source, int severity) {
		super(message);
	...
	public SessionOverdueException(String message,Exception e, int source, int severity) {
	...
	public SessionOverdueException(Exception e, int source, int severity) {
