...
public class ServiceException extends BaseException{
	...
	public ServiceException(String message, int source, int severity) {
		super(message);
	...
	public ServiceException(String message,Exception e, int source, int severity) {
	...
	public ServiceException(Exception e, int source, int severity) {
