...
public class ActionException extends BaseException{ 
	...
	public ActionException(String message,Exception e, int source, int severity) {
	...
	public ActionException(Exception e, int source, int severity) {
