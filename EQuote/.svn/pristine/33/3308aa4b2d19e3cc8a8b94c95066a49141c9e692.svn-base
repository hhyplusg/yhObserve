...
public class EqinquirytargetExample extends BaseVo implements Serializable {
    /**
     ...
     * This class corresponds to the database table EQINQUIRYTARGET
     *
     * @mbg.generated
     */
