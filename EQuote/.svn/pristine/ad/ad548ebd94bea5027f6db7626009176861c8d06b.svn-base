...
public class EquotetargetExample extends BaseVo implements Serializable {
    /**
     ...
     * This class corresponds to the database table EQUOTETARGET
     *
     * @mbg.generated
     */
